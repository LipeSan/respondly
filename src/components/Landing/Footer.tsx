    ...
    <footer data-testid="site-footer" className="relative border-t border-white/10 py-14">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-10">
        <div className="md:col-span-2">
          <div className="relative h-9 w-auto max-w-xs">
            <Image
              src={LOGO_FULL}
              alt="Respondly"
              fill
        ...
        <div>
          <p className="font-heading text-xs uppercase tracking-[0.2em] text-zinc-400 font-semibold">Product</p>
        ...
        <div>
          <p className="font-heading text-xs uppercase tracking-[0.2em] text-zinc-400 font-semibold">Company</p>
          <ul className="mt-4 space-y-2 text-sm text-zinc-400">
      ...
      <div className="mt-10 max-w-7xl mx-auto px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-zinc-400">
